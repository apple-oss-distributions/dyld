...
struct VIS_HIDDEN ChunkBumpAllocatorChunk
{
...
class VIS_HIDDEN ChunkBumpAllocatorZoneImpl
{
public:
...
// TODO: Get the 88 from somewhere else, eg, a helper method.   Not a hard coded value.
const size_t sAtomAllocatorMinReuseSize = 0x1000 / 88;
