...
// BUILD(macos,ios,tvos,watchos): RC_XBS=NO $CXX main.cpp -o $BUILD_DIR/asan_launch_via_asan_libsystem_variant_cxx.exe
// BUILD(macos,ios,tvos,watchos): $DYLD_ENV_VARS_ENABLE $BUILD_DIR/asan_launch_via_asan_libsystem_variant_cxx.exe

// RUN:  DYLD_PRINT_SEARCHING=1 DYLD_PRINT_LIBRARIES=1 DYLD_IMAGE_SUFFIX=_asan ./asan_launch_via_asan_libsystem_variant_cxx.exe
