// BUILD:  $DKCC dext.c -o $BUILD_DIR/dext.exe -Wl,-client_name,DriverKit -lSystem -nostdlib
// BUILD:  $CC main.c -o $BUILD_DIR/driverkit-dlfcn.exe -DRUN_DIR="$RUN_DIR"
// BUILD:  $DEXT_SPAWN_ENABLE $BUILD_DIR/driverkit-dlfcn.exe

// RUN:  $SUDO ./driverkit-dlfcn.exe
