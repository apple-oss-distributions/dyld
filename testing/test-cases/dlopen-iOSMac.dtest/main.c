// BUILD(macos):  $CC main.c   -o $BUILD_DIR/dlopen-iOSMac.exe -DFOR_IOSMAC=1  -target x86_64-darwin-ios-macabi
// BUILD(macos):  $CC main.c   -o $BUILD_DIR/dlopen-macOS.exe -DRUN_DIR="$RUN_DIR"
// BUILD(macos):  $CC cat.c -dynamiclib -install_name $RUN_DIR/libcat.dylib  -o $BUILD_DIR/libcat.dylib -target x86_64-darwin-ios-macabi
