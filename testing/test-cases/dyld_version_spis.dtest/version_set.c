...
// BUILD(macos):  $CC version_set.c -Wl,-platform_version,macos,12.0,12.0     -o $BUILD_DIR/version_set_12.exe
...
// BUILD(tvos):  $CC version_set.c -Wl,-platform_version,tvos,15.0,15.0 -o $BUILD_DIR/version_set_15.exe
...
// BUILD(ios):  $CC version_set.c -Wl,-platform_version,ios,15.0,15.0 -o $BUILD_DIR/version_set_15.exe
...
// BUILD(watchos):  $CC version_set.c -Wl,-platform_version,watchos,8.0,8.0 -o $BUILD_DIR/version_set_8.exe
...
#define FALL_2019 true
#define FALL_2020 true
#define FALL_2021 true
#define VERSION_NAME "macOS 12"
...
#elif (__ENVIRONMENT_TV_OS_VERSION_MIN_REQUIRED__ == 150000)
#define FALL_2018 true
#define FALL_2019 true
#define FALL_2020 true
#define FALL_2021 true
#define VERSION_NAME "tvOS 15"
...
#elif (__ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__ == 150000)
#define FALL_2018 true
#define FALL_2019 true
#define FALL_2020 true
#define FALL_2021 true
#define VERSION_NAME "iOS 15"
...
#elif (__ENVIRONMENT_WATCH_OS_VERSION_MIN_REQUIRED__ == 80000)
#define FALL_2018 true
#define FALL_2019 true
#define FALL_2020 true
#define FALL_2021 true
#define VERSION_NAME "watchOS 8"
#else
...
int main(void) {
    ...
    testVersionChecks("dyld_fall_2021_os_versions", dyld_fall_2021_os_versions, FALL_2021);
    ...
    testVersionChecks("dyld_platform_version_macOS_12_00", dyld_platform_version_macOS_12_00, FALL_2021);
    ...
    testVersionChecks("dyld_platform_version_tvOS_15_0", dyld_platform_version_tvOS_15_0, FALL_2021);
    ...
    testVersionChecks("dyld_platform_version_iOS_15_0", dyld_platform_version_iOS_15_0, FALL_2021);
    ...
    testVersionChecks("dyld_platform_version_watchOS_8_0", dyld_platform_version_watchOS_8_0, FALL_2021);
#endif
