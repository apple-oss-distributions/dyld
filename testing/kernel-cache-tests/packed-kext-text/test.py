...
# __TEXT_EXEC should be packed at sub-page alignment
...
def check(kernel_cache):
    ...
    assert kernel_cache.dictionary()["dylibs"][1]["segments"][1]["vmSize"] == "0x30"
    # foo.kext
    ...
    assert kernel_cache.dictionary()["dylibs"][2]["segments"][1]["vmSize"] == "0x18"
