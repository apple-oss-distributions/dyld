...
def check(kernel_cache):
    kernel_cache.buildKernelCollection("x86_64", "/kmod-info-missing/main.kc", "/kmod-info-missing/main.kernel", "/kmod-info-missing/extensions", ["com.apple.foo", "com.apple.bar"], ["-json-errors"])
    ...
    assert kernel_cache.dictionary()[0]["errors"][0] == "cannot be placed in kernel collection because: kexts must have a _kmod_info symbol"
