...
#if (BUILDING_DYLD || BUILDING_LIBDYLD) && TARGET_OS_OSX && defined(__x86_64__)
...
#if (BUILDING_DYLD || BUILDING_LIBDYLD || BUILDING_ALLOCATOR_UNIT_TESTS) && __arm64e__ && !TARGET_OS_EXCLAVEKIT && !TARGET_OS_SIMULATOR
#define DYLD_FEATURE_USE_HW_TPRO (1)
#else
#define DYLD_FEATURE_USE_HW_TPRO (0)
#endif /* (BUILDING_DYLD || BUILDING_LIBDYLD || BUILDING_ALLOCATOR_UNIT_TESTS) && __arm64e__ && !TARGET_OS_EXCLAVEKIT && !TARGET_OS_SIMULATOR */
